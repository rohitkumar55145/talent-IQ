...
function ActiveSessions({ sessions = [], isLoading = false, isUserInSession }) {
  return (
        ...
        <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-primary/20 rounded-3xl flex items-center justify-center">
                <SparkleIcon className="w-10 h-10 text-primary/50" />
              </div>
