...
function SessionPage() {
  ...
  // redirect the "partipipant" when session ends
  useEffect(() => {
  ...
  const handleEndSession = () => {
    if (
      ...
      endSession(id, { onSuccess: () => navigate("/dashboard") })
    }
  }
              ...
              <div className="p-6 space-y-6">
                ...
                {problemData?.constraints &&
                  problemData.constraints.length > 0 && (
                    <div className="bg-base-300 rounded-xl shadow-sm p-5 border border-base-300">
                      <h2 className="text-xl font-bold mb-4 text-base-content">
                        Constraints
                      </h2>
